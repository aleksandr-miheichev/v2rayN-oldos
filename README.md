...
application has been started on Ubuntu 22.04, Debian 12 and Rocky Linux 9, and unless every shipped binary stays
within the `GLIBC_2.34` baseline. Release notes are generated from the commits that actually landed, and list
changes that produced no commit at all — a dependency resolving to a new version, a rebuilt native library.
